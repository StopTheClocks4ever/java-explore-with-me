...
CREATE INDEX ix_initiator_id ON events (initiator_id);
CREATE INDEX ix_category_id ON events (category_id);
CREATE INDEX ix_location_id ON events (location_id);
...
CREATE INDEX ix_event_id ON requests (event_id);
CREATE INDEX ix_requester_id ON requests (requester_id);
